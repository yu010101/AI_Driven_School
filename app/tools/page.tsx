            ...
            <div key={tool.slug} className="relative">
              {tool.status === 'available' ? (
                ...
                >
                  ...
                  <h3 className="font-bold text-xl mb-2 group-hover:text-[#0A0A0A] transition-colors">
                    {tool.title}
                  </h3>
                  <p className="text-[#525252] text-sm mb-4">
                    {tool.description}
                  </p>
                  <span className="inline-flex items-center gap-2 text-[#0A0A0A] font-semibold text-sm">
                    使ってみる
                ...
                <div className="card p-6 h-full opacity-70">
                  <div
                    className="w-14 h-14 rounded-2xl flex items-center justify-center text-white mb-4 opacity-50"
                    style={{ backgroundColor: tool.color }}
                  >
                    {tool.icon}
                  </div>
